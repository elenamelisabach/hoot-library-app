        ...
        <Carousel className=" justify-content-center align-items-center m-auto">
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p className="fw-semibold">
                ...
                our vast collection of books, from timeless classics to the
                latest bestsellers. Whether you're seeking inspiration,
                adventure, or knowledge, Hoot Library has something for every
                reader. Start your journey today!
              </p>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p className="fw-semibold">
                Books are the key to endless opportunities. At Hoot Library,
                we’re here to help you expand your knowledge and embrace new
                ideas. Start your journey to growth with our diverse collection!
              </p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
