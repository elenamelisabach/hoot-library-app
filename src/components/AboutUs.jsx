import { Accordion, Container, Image, Row, Col } from "react-bootstrap";
            ...
            <Accordion defaultActiveKey="0" className="w-100 p-4">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  everyone. We aim to create a space where people can discover
                  new ideas, expand their knowledge, and enjoy the pleasure of
                  reading.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                  Immerse yourself in magical worlds and epic adventures with
                  our collection of fantasy books. From mythical creatures and
                  enchanted lands to powerful heroes and dark forces, our
                  fantasy section offers thrilling tales that will captivate
                  your imagination.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="2">
                ...
                <Accordion.Body>
                  Take a journey through time with our vast collection of
                  history books. Whether you're interested in ancient
                  civilizations, world wars, or the evolution of societies, our
                  history section provides a wealth of knowledge.
                </Accordion.Body>
              </Accordion.Item>
              ...
              <Accordion.Item eventKey="4">
                ...
                <Accordion.Body>
                  ...
                  biology, chemistry, or space exploration, our collection
                  offers insights into the forces that govern life and the
                  cosmos.
                </Accordion.Body>
              </Accordion.Item>
              ...
              <Accordion.Item eventKey="6">
                ...
                <Accordion.Body>
                  For any inquiries or concerns, please don't hesitate to use
                  the contact page. Our team is here to help with any questions
                  about your orders, book availability, or anything else. We
                  value your experience with Hoot Library and are ready to
                  assist you!
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
